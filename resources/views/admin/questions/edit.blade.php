...
@section('content')
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item">@lang('questions.questions')</li>
    </ul>
                            ...
                            <table class="table datatable" id="questions-table" style="width: 100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <th>@lang('questions.name')</th>
                                        <th>@lang('questions.users_count')</th>
...
@push('scripts')
    <script>
        let questionsTable = $('#questions-table').DataTable({
            dom: "tiplr",
            serverSide: true,
            processing: true,
            "language": {
        ...
        $('#data-table-search').keyup(function() {
            questionsTable.search(this.value).draw();
        })
    </script>
@endpush
