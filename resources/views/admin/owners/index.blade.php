...
@section('content')
    ...
    <div>
        <h2>@lang('owners.owners')</h2>
    </div>

    <ul class="breadcrumb mt-2">
        <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">@lang('site.home')</a></li>
        <li class="breadcrumb-item">@lang('owners.owners')</li>
    </ul>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        @if (auth()->user()->hasPermission('read_owners'))
                            <a href="{{ route('admin.owners.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('site.create')</a>
                        @endif

                        @if (auth()->user()->hasPermission('delete_owners'))
                            <form method="post" action="{{ route('admin.owners.bulk_delete') }}" style="display: inline-block;">
                                @csrf
                                @method('delete')
