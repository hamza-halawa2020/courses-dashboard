                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        @if (auth()->user()->hasPermission('create_qRvalues'))
                            <a href="{{ route('admin.qRvalues.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i>
                                @lang('site.create')</a>
                        @endif

                        @if (auth()->user()->hasPermission('delete_qRvalues'))
                            <form method="post" action="{{ route('admin.qRvalues.bulk_delete') }}"
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <input type="text" id="data-table-search" class="form-control" autofocus
                                qRvalueholder="@lang('site.search')">
                        </div>
                    </div>
