...
@section('content')
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item">@lang('places.places')</li>
    </ul>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
                        ...
                        @if (auth()->user()->hasPermission('create_places'))
                            <a href="{{ route('admin.places.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> @lang('site.create')</a>
                        @endif

                        @if (auth()->user()->hasPermission('delete_places'))
                            <form method="post" action="{{ route('admin.places.bulk_delete') }}" style="display: inline-block;">
                                @csrf
                                @method('delete')
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table datatable" id="places-table" style="width: 100%;">
                                <thead>
                                <tr>
                                    <th>
...
@push('scripts')
    ...
    <script>
        ...
        let placesTable = $('#places-table').DataTable({
            dom: "tiplr",
            serverSide: true,
            processing: true,
            "language": {
        ...
        $('#data-table-search').keyup(function () {
            placesTable.search(this.value).draw();
        })
    </script>
